...
<html>
  ...
  <body>
	<!--登出鍵-->
	<button type="button" class="btn btn-link"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>登出</button>
	
	<div class="container col-md-8 col-md-offset-2 navbar-collapse-center">
		<a href="index.html"><img src="img/waisln.jpg" alt="華新麗華資料收集平台" class="img-responsive center-block"></a>
	<!--nav-->	
